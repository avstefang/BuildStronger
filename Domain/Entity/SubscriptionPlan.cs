...
public class SubscriptionPlan(
    ...
    public int WeeklyCreditAmount { get; private set; } = weeklyCreditAmount;
    ...
    public void ChangeWeeklyCreditAmount(int newWeeklyCreditAmount)
    {
        if (newWeeklyCreditAmount <= 0)
            throw new ArgumentException("Weekly credit amount must be greater than zero.", nameof(newWeeklyCreditAmount));
        WeeklyCreditAmount = newWeeklyCreditAmount;
    }
}
